...
<template>
  <div class="content-container">
    ...
    <div class="header-section">
      <el-input v-model="searchForm.keyword" placeholder="请输入收货人名" class="filter-input" :prefix-icon="Search"
                clearable/>
    ...
    <el-card>
      <el-table :data="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="收货人名"/>
        <el-table-column prop="address" label="地址"/>
        <el-table-column prop="info" label="具体地址"/>
    ...
    <el-dialog v-model="dialogFormVisible" :title="form.id ? '编辑' : '新增'" width="30%" center>
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="地址">
          <el-cascader v-model="form.address" :options="regionData" :props="{ value: 'label' }" clearable
                       style="width: 100%" placeholder="请输入地址"/>
        </el-form-item>
