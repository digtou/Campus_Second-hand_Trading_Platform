  ...
  <div class="content-container">
    ...
    <el-card>
      <el-table :data="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="商品详情描述" width="100" align="center">
          <template #default="scope">
            <el-button type="primary" @click="viewContent(scope.row.content)">查看</el-button>
          </template>
        </el-table-column>
        <el-table-column prop="place" label="商品所在地"/>
        <el-table-column label="发货设置" width="100" align="center">
          <template #default="scope">
            <el-tag>{{scope.row.shipment}}</el-tag>
          </template>
        </el-table-column>
        <el-table-column label="商品成色" width="100" align="center">
          <template #default="scope">
