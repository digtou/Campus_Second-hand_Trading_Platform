...
<template>
  <div class="publish-container">
    <div class="publish-card">
      <div class="page-title">发布闲置</div>

      <div class="section">
        <div class="section-title">基础信息</div>

        <div class="form-item">
          <div class="label required">商品主图</div>
        ...
        <!-- 发货设置 -->
        <div class="form-item">
          <div class="label">发货设置</div>
          <el-radio-group v-model="form.shipment">
            <el-radio value="包邮" border>包邮</el-radio>
            <el-radio value="邮费到付" border>邮费到付</el-radio>
            <el-radio value="无须邮寄" border>无须邮寄</el-radio>
          </el-radio-group>
        </div>
      </div>
